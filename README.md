...
3. Dashboard (Головна сторінка, /):
   ...
   - Бекенд-задачі:
     1. Реалізувати ендпоінт: GET /api/routines/exercises (Список вправ певного режиму);
     2. Реалізувати ендпоінт: PUT /api/routines/{id}/reorder (Переупорядкувати вправи в певному режимі; приймає список routineExerciseId);
...
4. Routines (Режими, /routines):
   ...
   - Бекенд-задачі:
     1. Реалізувати ендпоінт: GET /api/routines (Отримання список режимів);
...
6. Add Exercise into Routine (Додавання вправи до режиму, /routines/{id}/exercises/add):
   ...
   - Бекенд-задачі:
     1. Реалізувати ендпоінт (якщо не реалізовано): GET /api/routines/exercises/{id} (Отримання певної вправи в режимі);
     2. Реалізувати ендпоінт: POST /api/routines/exercises (Додавання певної вправи в режим);
     3. Реалізувати запит (якщо не реалізовано): GetRoutineExerciseByIdQuery;
     4. Реалізувати команду: CreateRoutineExerciseCommand.
7. Create Exercise (Створення вправи, /exercises/create):
...
8. Exercises (Вправи, /exercises):
   ...
   - Бекенд-задачі:
     1. Реалізувати ендпоінт: GET /api/exercises (Отримання вправ)
...
9. Measurements (Виміри, /measurements):
...
11. Create Workout (Створення тренування, /routines/{id}/workout):
    ...
    - Бекенд-задачі:
      1. Реалізувати ендпоінт: POST /api/users/workouts (Створення тренування).
12. Workout History (Історія тренувань, /workout-history):
    ...
    - Бекенд-задачі:
      1. Реалізувати ендпоінт: GET /api/users/workouts (Отримання всіх тренувань);
      2. Реалізувати ендпоінт: PUT /api/users/workouts (Редагування тренування);
      3. Реалізувати ендпоінт: DELETE /api/users/workouts/{id} (Видалення тренування);
